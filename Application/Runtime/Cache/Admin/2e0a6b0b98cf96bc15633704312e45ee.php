...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <form name="myform" id="myform" method="post" action="/TP3/index.php/Admin/Admin/sort">
                <div class="result-title">
                    <div class="result-list">
                        <a href="/TP3/index.php/Admin/Admin/add"><i class="icon-font"></i>新增管理员</a>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($adminres)): $i = 0; $__LIST__ = $adminres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td title="<?php echo ($vo["username"]); ?>"><a target="_blank" href="#" title=""><?php echo ($vo["username"]); ?></a>
                            </td>
                            <td>
                                <a class="link-update" href="/TP3/index.php/Admin/Admin/edit/id/<?php echo ($vo["id"]); ?>">修改</a>
                                <a class="link-del" onclick="return confirm('确认删除？')" href="/TP3/index.php/Admin/Admin/del/id/<?php echo ($vo["id"]); ?>">删除</a>
                            </td>
