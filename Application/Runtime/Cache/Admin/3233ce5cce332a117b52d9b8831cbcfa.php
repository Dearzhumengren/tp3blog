...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <form name="myform" id="myform" method="post" action="/TP3/index.php/Admin/Article/sort">
                <div class="result-title">
                    <div class="result-list">
                        <a href="/TP3/index.php/Admin/Article/add"><i class="icon-font"></i>新增文章</a>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td>
                                <?php if($vo['pic'] != '' ): ?><img src="/TP3<?php echo ($vo["pic"]); ?>" height="50">
                            ...
                            <td>
                                <a class="link-update" href="/TP3/index.php/Admin/Article/edit/id/<?php echo ($vo["id"]); ?>">修改</a>
                                <a class="link-del" onclick="return confirm('确认删除？')" href="/TP3/index.php/Admin/Article/del/id/<?php echo ($vo["id"]); ?>">删除</a>
                            </td>
